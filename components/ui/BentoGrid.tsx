...
export const BentoGridItem = ({
  ...
  const leftLists = ["MongoDB", "React", "Node.js"];
  const rightLists = ["Python", "AWS", "PyTorch"];

  const handleCopy = () => {
    navigator.clipboard.writeText("itsnotsameer@gmail.com");
    setCopied(true);
  }
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(37,23,59,1) 35%, rgba(0,212,255,1) 100%)',
      }}
    >
